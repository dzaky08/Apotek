...
namespace projek_apotek
{
    ...
    {
        public static SqlConnection connection = new SqlConnection(@"Data Source=DESKTOP-GG5IPPK;Initial Catalog=db_apotek;Integrated Security=True");
        ...
        public static int insertLog(string aktifitas)
        {
            try
            {
                ...
                cmd = new SqlCommand($"INSERT INTO log values('{DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss")}', '{aktifitas}', '{LoginSession.id}')", connection);
